...
public class MyRecycler1Adapter extends RecyclerView.Adapter<MyRecycler1Adapter.MyViewHolder> {

    String data1[], data2[], data3[];
    int images[];
    Context context;

    public MyRecycler1Adapter(Context ct, String s1[], String s2[], String s3[], int img[]){
        context = ct;
        data1 = s1;
        data2 = s2;
        data3 = s3;
